...
-----------------------------
Milestone 4 answer:
40: train error = 0.03601575689364097, validation error = 0.26730444569499157
70: train error = 0.014631401238041642, validation error = 0.26139561057962857
80: train error = 0.012380416432189083, validation error = 0.263083849184018
90: train error = 0.009566685424873381, validation error = 0.2658975801913337

as numEpochs increase, value of train error decreases,
value of validation error decreases and later on increases
"""
...
#extract character feature get train error == 0, but higher validation error than extract word feature,
#it seems like using character feature might result in over fitting
############################################################
